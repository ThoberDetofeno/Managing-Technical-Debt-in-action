...
This section compiles our proposal for the TDM process and some strategies and tools resulting from the two action research cycles conducted over more than three years. This approach can be implemented as a whole or in parts, depending on the organization's context and goals.
